...
When the survey is submitted, a user with the closest matching responses is found. This is determined using the lowest absolute difference for all ten questions
...
*Friend Finder* is deployed to Heroku. Please check it out [here](https://sheltered-eyrie-12661.herokuapp.com/).

## Installation

To install the application follow the instructions below:

	git clone git@github.com:dreadsovereign/friendfinder.git
	cd friendfinder
	npm install
